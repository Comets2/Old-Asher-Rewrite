function menuui_scr(argument0) {
	...
	draw_text_ext_transformed_colour(drawxpos+109,drawypos+28+16*4,"Controls",1,1000,0.5,0.5,0,textcolgold,textcolgold,textcolgold,textcolgold,1)
	...
	if(option==4){
	draw_text_ext_transformed_colour(drawxpos+109,drawypos+28+16*4,"Controls",1,1000,0.5,0.5,0,textcolgoldtwo,textcolgoldtwo,textcolgoldtwo,textcolgoldtwo,1)
	}else{
	if(option==5){
