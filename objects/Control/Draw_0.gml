...
for(a=0;a<10;a+=1){
for(b=0;b<10;b+=1){
draw_sprite(cloudscroll_spr,0,xspot+(a*32)+(animdraw)-32,yspot+(b*32)+(animdraw)-32)
}}
for(a=0;a<5;a+=1){
for(b=0;b<5;b+=1){
draw_sprite(cloudscroll3_spr,0,xspot+(a*128)+(animdraw3)-128,yspot+(b*128)+(animdraw3)-128)
}}

for(a=0;a<5;a+=1){
for(b=0;b<5;b+=1){
draw_sprite(cloudscroll5_spr,0,xspot+(a*128)+(animdraw5)-128,yspot+(b*128)+(animdraw5)-128)
}}
for(a=0;a<10;a+=1){
for(b=0;b<10;b+=1){
draw_sprite(cloudscroll2_spr,0,xspot+(a*64)+(animdraw2)-64,yspot+(b*64)+(animdraw2)-64)
}}
for(a=0;a<10;a+=1){
for(b=0;b<10;b+=1){
draw_sprite(cloudscroll4_spr,0,xspot+(a*64)+(animdraw4)-64,yspot+(b*64)+(animdraw4)-64)
}}
}
